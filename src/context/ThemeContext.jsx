...
export const themeMap = {
  ...
  dark: {
    ...
    wrapper: "bg-gray-900 text-white font-serif font-bold min-h-screen flex",
    header: "bg-gray-800 shadow-lg text-white  w-1/5 min-h-screen p-4 fixed left-0 top-0",
    content: "ml-[20%] p-6 ", 
  },
  colorful: {
